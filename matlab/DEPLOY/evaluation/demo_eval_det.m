...
function [return_ap tp_ret fp_ret num_pos_ret]=demo_eval_det(ground_truth_dir,results_txt)
    
    %fprintf('DETECTION TASK\n');

    pred_file=results_txt;
    ...
    [ap recall precision  tp_ret fp_ret num_pos_ret] = eval_detection(pred_file,ground_truth_dir,meta_file,eval_file,blacklist_file,optional_cache_file);
