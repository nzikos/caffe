...
%% Brief explanation
%
%   ILSVRC EXTRACT is taking as input 1 entry of metadata array and extracts the
%   objects to 'appendTo' directory. appendTo is set to be inside cache/objects/'SET'
%   The dimensions of the object are set under 'dims' input as a 2-element array
%   [height width];
%   Labels is a struct which contains the semantics that should follow the
%   data. It is described under 'object_extraction/object_labels.m'
%   
