...
%GET_SHRINKED_meta Returns a shrinked metadata array of a specific dataset
%                  of a specific classID.
%                  This function is used to reduce the memory size that 
%                  workers need in case of very large contests like... ILSVRC.
%
