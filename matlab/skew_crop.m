...
rotation_matrix = [cosd(theta) -sind(theta) 0;
                   ...
                   0           0            1];
unknown_matrix = [1 0 randomValue1;
                  0 1 randomValue2;
                  0 0 1];

P=shear_matrix*rotation_matrix*unknown_matrix;

tform = projective2d(P);

%tform = projective2d([cosd(theta) -sind(theta) 0.002;
%                       sind(theta)  cosd(theta) 0.0004;
%                       2560       200       1]);
tic;
tmp=imwarp(im,tform);
toc;
