...
model.objects.compute_mean_std(0);
...
net.caffe.structure.add_CONV_layer   ('conv1',96,11,4,0,true,'gaussian',0.01,1,'constant',0,1);
net.caffe.structure.add_ACTIV_layer  ('relu1','relu');
%net.caffe.structure.add_LRN_layer    ('lrn1' ,3,0.00005,0.75,'within_channel');
net.caffe.structure.add_POOL_layer   ('pool1','MAX',3,2,0);
net.caffe.structure.add_CONV_layer   ('conv2',256,5,1,2,true,'gaussian',0.01,1,'constant',0,1);
net.caffe.structure.add_ACTIV_layer  ('relu2','relu');
%net.caffe.structure.add_LRN_layer    ('lrn2' ,3,0.00005,0.75,'within_channel');
net.caffe.structure.add_POOL_layer   ('pool2','MAX',3,2,0);
...
net.caffe.structure.add_POOL_layer   ('pool5','MAX',3,2,0);
